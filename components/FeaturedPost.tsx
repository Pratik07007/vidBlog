...
function FeaturedPost() {
    return (
        <div className={`${fontRaleway.className} min-h-[80vh]  bg-secondary-background flex flex-col sm:flex-row px-5 sm:px-10 items-center justify-center pb-5 gap-5  `}>
            <div className=' sm:h-auto sm:w-[55vw] w-[90vw] pt-5 sm:pt-0 flex '>
                <div className='text-primary-background flex flex-col items-start justify-center gap-5' >
                    ...
                    <p className='font-light text-sm'>The future of AI will see home robots having enhanced intelligence, increased capabilities, and becoming more personal and possibly cute. For example, home robots will overcome navigation, direction
            ...
            <div className=' w-[90vw] sm:w-[45vw]  flex  items-center justify-center '>
